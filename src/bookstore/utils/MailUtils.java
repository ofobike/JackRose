...
public class MailUtils {
    ...
    public void sendMail() {
        ...
        try {
            ...
            // 2.3设置邮件主题
            message.setSubject("新垣结衣给你发送了一封邮件");
            // 2.4设置邮件内容
            String content =
                    "<html><head></head><body><h1>这是一封激活邮件,激活请点击以下链接</h1><h3><a href='http://localhost:8080/servlet/ClientServlet?code="
                            + code + "'>http://localhost:8080/servlet/ClientServlet?code=" + code
                            + "</href></h3></body></html>";
