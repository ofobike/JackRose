...
<%@ include file="/client/head.jsp"%>
    	...
    	<table border="1" width=800">
    		...
    		<tr>
    			<td align="right" colspan="6">
    				...
    				<a href="${pageContext.request.contextPath}/servlet/ClientServlet?method=genOrder">去结算</a>
    			</td>
    		</tr>
    	</table>
    </c:if>
    <script type="text/javascript">
    	function delOneItem(bookId){
    		...
    		if(sure){
    			location.href="${pageContext.request.contextPath}/servlet/ClientServlet?method=delOneItem&bookId="+bookId;
    		}
    	}
...
//     			改为1
    		...
    		if(sure){
    			location.href="${pageContext.request.contextPath}/servlet/ClientServlet?method=changeNum&bookId="+bookId+"&num="+value;
    		}else{
    			//改回原来的数量
